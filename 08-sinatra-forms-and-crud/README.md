...
### REST & CRUD
- [ ] Create
  - [ ] GET '/trainers/new' -> Show the user a form to create a new doctor
  - [ ] POST '/trainers' -> Create a new doctor in our database
- [ ] Read
  - [ ] GET '/trainers' -> Show all trainers
  - [ ] GET '/trainers/:id' -> Show one doctor
- [ ] Update
  - [ ] GET '/trainers/:id/edit' -> Show the user a form to edit an existing doctor doctor
  - [ ] PATCH '/trainers/:id' -> Update the doctor in our database
- [ ] Delete
  - [ ] DELETE '/trainers/:id' -> Delete the doctor from our database
